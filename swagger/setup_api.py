...
# set up request parameters for our web service
...
class CreditApi(Resource):
    ...
    def get_result(self, args):
        ...
        df = DataFrame([[debtRatio,monthlyIncome,dependents,openCreditLinesAndLoans,pastDue30Days,pastDue60Days,pastDue90Days,realEstateLoansOrLines,unsecuredLines,age]])
        from sklearn.externals import joblib
